...
export default function Main() {
    ...
    return (
        <div className='bg-indigo-800 flex flex-col justify-between mx-4 px-4 my-4 md:w-2/3 md:mx-auto'>
            ...
            <textarea className='bg-indigo-500 w-full min-h-32 p-2 placeholder-indigo-200 border-2 border-indigo-200 rounded mb-4' placeholder='Describe your day: 😊'></textarea>
            ...
            <div className="flex gap-10 pb-4">
                <button className='bg-red-500 text-white text-xl md:text-3xl p-2 rounded w-full'>Clear</button>
